...
import { useDataStore } from '../../store/data' // pegando os dados salvos dos usuarios
import { api } from '../../services/api'
import { useQuery } from '@tanstack/react-query' // para fazer as requisicoes http do backend
...
export default function Nutrition() {
    ...
    console.log(user) // mostrando os dados do usuario na tela

    // preciso mandar os dados para a api para fazer a requisição e fazer a dieta com base nos dados do user
    const {data, isFetching, error} = useQuery({
        ...
        } // função para disparar que é a requisição
    })
    ...
    if (isFetching) {
        return (
            <View style={styles.loading}>
                <Text style={styles.loadingText}>Estamos gerando usa dieta!</Text>
